    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/materialadmin").Include(
                      ...
                      "~/MaterialAdmin/vendors/bower_components/animate.css/animate.min.css",
                      "~/MaterialAdmin/vendors/bower_components/sweetalert2/dist/sweetalert2.min.css",
            ...
            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                ...
                "~/MaterialAdmin/vendors/bower_components/sweetalert2/dist/sweetalert2.min.js",
