...
!function (t, i) {
    ...
    function e(i) {
        if ("snarl-wrapper" !== i.toElement.getAttribute("id")) {
            for (var n = i.toElement, e = !1; !l(n, "snarl-notification");)
                l(n, "snarl-close") && (e = !0), n = n.parentElement;
            var o = n.getAttribute("id");
            if (o = /snarl-notification-([a-zA-Z0-9]+)/.exec(o)[1], e && u.notifications[o].options.dismissable)
                u.removeNotification(o);
            else {
